...
def nms(boxes, scores, overlap=0.5, top_k=200):
    ...
    while idx.numel() > 0:
        ...
        # load bboxes of next highest vals, store element-wise max with next highest score
        ...
        w = torch.clamp(xx2 - xx1, min=0.0, max=float('inf'))
        h = torch.clamp(yy2 - yy1, min=0.0, max=float('inf'))
